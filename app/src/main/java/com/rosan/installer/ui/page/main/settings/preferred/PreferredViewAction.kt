...
sealed class PreferredViewAction {
    ...
    data class ChangeVersionCompareInSingleLine(val versionCompareInSingleLine: Boolean) :
        PreferredViewAction()
    ...
    data class RemoveManagedSharedUserIdExemptedPackages(val pkg: NamedPackage) :
        PreferredViewAction()
