 ...
 */
fun isDhizukuActive(stateAuthorizer: Authorizer, globalAuthorizer: Authorizer) = when (stateAuthorizer) {
 ...
 */
fun isNoneActive(stateAuthorizer: Authorizer, globalAuthorizer: Authorizer) = when (stateAuthorizer) {
 ...
 */
fun isSystemPackageInstallerActive(stateAuthorizer: Authorizer, globalAuthorizer: Authorizer, isSystemApp: Boolean) = isSystemApp && isNoneActive(stateAuthorizer, globalAuthorizer)
