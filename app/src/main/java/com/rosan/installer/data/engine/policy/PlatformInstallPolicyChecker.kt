...
class PlatformInstallPolicyChecker(
    ...
    private fun hasPermission(permission: String, uid: Int): Boolean = context.checkPermission(permission, -1, uid) == PackageManager.PERMISSION_GRANTED
    ...
    private fun missingPermission(message: String): InstallException = InstallException(InstallErrorType.MISSING_INSTALL_PERMISSION, message)
}
