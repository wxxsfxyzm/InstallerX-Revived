...
data class ConfigEntity(
    ...
    @ColumnInfo(name = "authorizer")
    var authorizer: Authorizer,
    @ColumnInfo(name = "customize_authorizer")
    ...
    @ColumnInfo(name = "install_reason", defaultValue = "0")
    ...
    var installerMode: InstallerMode = InstallerMode.Self,
    @ColumnInfo(name = "installer")
    var installer: String?,
    @ColumnInfo(name = "enable_customize_user", defaultValue = "0")
    var enableCustomizeUser: Boolean = false,
    @ColumnInfo(name = "target_user_id", defaultValue = "0")
    var targetUserId: Int = 0,
    @ColumnInfo(name = "enable_manual_dexopt", defaultValue = "0")
    var enableManualDexopt: Boolean = false,
    @ColumnInfo(name = "force_dexopt", defaultValue = "0")
    ...
    var autoDeleteZip: Boolean = false,
    @ColumnInfo(name = "display_size", defaultValue = "0")
    var displaySize: Boolean = false,
    @ColumnInfo(name = "display_sdk", defaultValue = "0")
    var displaySdk: Boolean = false,
    @ColumnInfo(name = "for_all_user", defaultValue = "0")
    var forAllUser: Boolean = false,
    @ColumnInfo(name = "allow_test_only", defaultValue = "0")
    var allowTestOnly: Boolean = false,
    @ColumnInfo(name = "allow_downgrade", defaultValue = "0")
    var allowDowngrade: Boolean = false,
    @ColumnInfo(name = "bypass_low_target_sdk", defaultValue = "0")
    var bypassLowTargetSdk: Boolean = false,
    @ColumnInfo(name = "allow_all_requested_permissions", defaultValue = "0")
    var allowAllRequestedPermissions: Boolean = false,
    @ColumnInfo(name = "allow_sig_mismatch", defaultValue = "0")
    var allowSigMismatch: Boolean = false,
    @ColumnInfo(name = "allow_sig_unknown", defaultValue = "0")
    var allowSigUnknown: Boolean = false,
    @ColumnInfo(name = "request_update_ownership", defaultValue = "0")
    var requestUpdateOwnership: Boolean = false,
    @ColumnInfo(name = "split_choose_all", defaultValue = "0")
    var splitChooseAll: Boolean = false,
    @ColumnInfo(name = "apk_choose_all", defaultValue = "0")
    var apkChooseAll: Boolean = false,
    @ColumnInfo(name = "require_biometric_auth", defaultValue = "0")
