...
class RecordOperationHistoryUseCase(private val repository: OperationHistoryRepository) {
...
fun Throwable.historyErrorSummary(): String = message?.take(MAX_ERROR_SUMMARY_LENGTH) ?: this::class.simpleName.orEmpty()
