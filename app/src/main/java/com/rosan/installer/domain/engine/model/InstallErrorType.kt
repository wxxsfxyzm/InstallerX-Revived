...
enum class InstallErrorType(val legacyCode: Int, @param:StringRes val stringResId: Int) {
    ...
    INSTALL_FAILED_PERMISSION_MODEL_DOWNGRADE(-26, R.string.exception_install_failed_permission_model_downgrade),
    INSTALL_FAILED_SANDBOX_VERSION_DOWNGRADE(-27, R.string.exception_install_failed_sandbox_version_downgrade),
    ...
    INSTALL_PARSE_FAILED_MANIFEST_EMPTY(-109, R.string.exception_install_parse_failed_manifest_empty),
    ...
    INSTALL_FAILED_DUPLICATE_PERMISSION_GROUP(-126, R.string.exception_install_failed_duplicate_permission_group),
    INSTALL_FAILED_BAD_PERMISSION_GROUP(-127, R.string.exception_install_failed_bad_permission_group),
    INSTALL_FAILED_PRE_APPROVAL_NOT_AVAILABLE(-129, R.string.exception_install_failed_pre_approval_not_available),
    INSTALL_FAILED_MULTI_ARCH_NOT_MATCH_ALL_NATIVE_ABIS(-131, R.string.exception_install_failed_multi_arch_not_match_all_native_abis),
