...
enum class InstallErrorType(val legacyCode: Int, @param:StringRes val stringResId: Int) {
    ...
    INSUFFICIENT_STORAGE(
        PackageManagerHidden.INSTALL_FAILED_INSUFFICIENT_STORAGE,
        R.string.exception_install_failed_insufficient_storage,
    ),
    ...
    UPDATE_INCOMPATIBLE(
        PackageManagerHidden.INSTALL_FAILED_UPDATE_INCOMPATIBLE,
        R.string.exception_install_failed_update_incompatible,
    ),
    SHARED_USER_INCOMPATIBLE(
        PackageManagerHidden.INSTALL_FAILED_SHARED_USER_INCOMPATIBLE,
        R.string.exception_install_failed_shared_user_incompatible,
    ),
    MISSING_SHARED_LIBRARY(
        PackageManagerHidden.INSTALL_FAILED_MISSING_SHARED_LIBRARY,
        R.string.exception_install_failed_missing_shared_library,
    ),
    REPLACE_COULDNT_DELETE(
        PackageManagerHidden.INSTALL_FAILED_REPLACE_COULDNT_DELETE,
        R.string.exception_install_failed_replace_couldnt_delete,
    ),
    ...
    CONFLICTING_PROVIDER(
        PackageManagerHidden.INSTALL_FAILED_CONFLICTING_PROVIDER,
        R.string.exception_install_failed_conflicting_provider,
    ),
    ...
    CPU_ABI_INCOMPATIBLE(
        PackageManagerHidden.INSTALL_FAILED_CPU_ABI_INCOMPATIBLE,
        R.string.exception_install_failed_cpu_abi_incompatible,
    ),
    ...
    INVALID_INSTALL_LOCATION(
        PackageManagerHidden.INSTALL_FAILED_INVALID_INSTALL_LOCATION,
        R.string.exception_install_failed_invalid_install_location,
    ),
    ...
    VERIFICATION_TIMEOUT(
        PackageManagerHidden.INSTALL_FAILED_VERIFICATION_TIMEOUT,
        R.string.exception_install_failed_verification_timeout,
    ),
    VERIFICATION_FAILURE(
        PackageManagerHidden.INSTALL_FAILED_VERIFICATION_FAILURE,
        R.string.exception_install_failed_verification_failure,
    ),
    ...
    INSTALL_FAILED_PERMISSION_MODEL_DOWNGRADE(
        PackageManagerHidden.INSTALL_FAILED_PERMISSION_MODEL_DOWNGRADE,
        R.string.exception_install_failed_permission_model_downgrade,
    ),
    INSTALL_FAILED_SANDBOX_VERSION_DOWNGRADE(
        PackageManagerHidden.INSTALL_FAILED_SANDBOX_VERSION_DOWNGRADE,
        R.string.exception_install_failed_sandbox_version_downgrade,
    ),
    ...
    DEPRECATED_SDK_VERSION(
        PackageManagerHidden.INSTALL_FAILED_DEPRECATED_SDK_VERSION,
        R.string.exception_install_failed_deprecated_sdk_version,
    ),
    PARSE_FAILED_UNEXPECTED_EXCEPTION(
        PackageManagerHidden.INSTALL_PARSE_FAILED_UNEXPECTED_EXCEPTION,
        R.string.exception_install_parse_failed_unexpected_exception,
    ),
    PARSE_FAILED_NO_CERTIFICATES(
        PackageManagerHidden.INSTALL_PARSE_FAILED_NO_CERTIFICATES,
        R.string.exception_install_parse_failed_no_certificates,
    ),
    PARSE_FAILED_BAD_SHARED_USER_ID(
        PackageManagerHidden.INSTALL_PARSE_FAILED_BAD_SHARED_USER_ID,
        R.string.exception_install_parse_failed_bad_shared_user_id,
    ),
    INSTALL_PARSE_FAILED_MANIFEST_EMPTY(
        PackageManagerHidden.INSTALL_PARSE_FAILED_MANIFEST_EMPTY,
        R.string.exception_install_parse_failed_manifest_empty,
    ),
    ...
    DUPLICATE_PERMISSION(
        PackageManagerHidden.INSTALL_FAILED_DUPLICATE_PERMISSION,
        R.string.exception_install_failed_duplicate_permission,
    ),
    NO_MATCHING_ABIS(
        PackageManagerHidden.INSTALL_FAILED_NO_MATCHING_ABIS,
        R.string.exception_install_failed_cpu_abi_incompatible,
    ),
    ...
    INSTALL_FAILED_DUPLICATE_PERMISSION_GROUP(
        PackageManagerHidden.INSTALL_FAILED_DUPLICATE_PERMISSION_GROUP,
        R.string.exception_install_failed_duplicate_permission_group,
    ),
    INSTALL_FAILED_BAD_PERMISSION_GROUP(
        PackageManagerHidden.INSTALL_FAILED_BAD_PERMISSION_GROUP,
        R.string.exception_install_failed_bad_permission_group,
    ),
    INSTALL_FAILED_PRE_APPROVAL_NOT_AVAILABLE(
        PackageManagerHidden.INSTALL_FAILED_PRE_APPROVAL_NOT_AVAILABLE,
        R.string.exception_install_failed_pre_approval_not_available,
    ),
    INSTALL_FAILED_MULTI_ARCH_NOT_MATCH_ALL_NATIVE_ABIS(
        PackageManagerHidden.INSTALL_FAILED_MULTI_ARCH_NOT_MATCH_ALL_NATIVE_ABIS,
        R.string.exception_install_failed_multi_arch_not_match_all_native_abis,
    ),
