...
data class ConfigModel(
    ...
    val installRequesterMode: InstallRequesterMode = InstallRequesterMode.Disable,
    ...
    companion object {
        var default = ConfigModel(
            ...
            installRequesterMode = InstallRequesterMode.Disable,
            ...
            networkSourceMode = NetworkSourceMode.Cache,
            networkRangeCacheSizeMiB = DEFAULT_NETWORK_RANGE_CACHE_SIZE_MIB,
            autoDelete = false,
            autoDeleteZip = false,
            displaySize = false,
            displaySdk = false,
