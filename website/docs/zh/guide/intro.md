...
### 高级工具 (Advanced Power Tools)
对于发烧友，InstallerX Revived 提供了标准安装器中没有的功能：
* **按来源配置 (Per-Source Profiles):** 您可以根据 *发起安装的应用* 自定义安装行为。例如，您可以为浏览器和文件管理器分别应用不同的安装选项（如静默安装或特定标记）。
...
请参阅 [快速开始](/zh/guide/getting-started)。
